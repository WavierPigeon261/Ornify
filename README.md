...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/WavierPigeon261/Ornify/build.yml?style=flat-square)
[![Language](https://img.shields.io/badge/language-Kotlin-blue.svg?style=flat-square)](https://kotlinlang.org/)
...
- ⏰ History option to access completed orders
